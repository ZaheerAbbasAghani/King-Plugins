...
function ednm_day_night_shortcode(){ ?>

<style type="text/css">
<?php echo esc_attr(rtrim(get_option('ednm_all_classes'))); ?>
{
	background:#000 !important;
}

body.dark-mode p,body.dark-mode a {
	color: <?php echo esc_attr(get_option('ednm_color_picker_val')); ?> !important;
}
...
add_shortcode("day_night_on", "ednm_day_night_shortcode" );
