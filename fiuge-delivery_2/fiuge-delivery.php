...
function __construct() {
	...
	add_action( 'woocommerce_checkout_create_order', array($this,'fde_create_invoice_for_wc_order'),  1, 1  );
...
function fde_create_invoice_for_wc_order($order) {
    ...
    $body = array (
        'sender' => 
              ...
              array (
                'name' => $name,
                'phoneCountryCode' => $_COOKIE["country_code"],
                'phoneNumber' => $phone,
        ...
        'pickupDateTime' => $_COOKIE["fdeDeliveryPickUpTime"],
        'additionalInformation' => $note,
        'numberOfItems' => $quantity,
        'senderOrderNumber' => $id,
        'deliveryCountry' => $country ,
        'deliveryDateTime' => $_COOKIE["fdeDeliveryPickUpTime"],
    );
