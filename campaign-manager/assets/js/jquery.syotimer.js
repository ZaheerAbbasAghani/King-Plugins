 ...
 */
(function (jQueryjQuery1) {
    'use strict';

    function _interopDefaultLegacy (e) { return e && typeof e === 'object' && 'default' in e ? e : { 'default': e }; }

    var jQuery__default = /*#__PURE__*/_interopDefaultLegacy(jQueryjQuery1);

    jQuery__default['default'].syotimerLang = {
        rus: {
    ...
    var defaultOptions = {
        ...
        itemsHas: jQuery__default['default'].extend({}, defaultItemsHas),
    };
    ...
    function getTimerItem() {
        var timerCellValue = jQuery('<div/>', {
            class: 'syotimer-cell__value',
            text: '0',
        });
        var timerCellUnit = jQuery('<div/>', { class: 'syotimer-cell__unit' });
        var timerCell = jQuery('<div/>', { class: 'syotimer-cell' });
    ...
    function getNumeral(n, lang, unit) {
        var handler = jQuery.syotimerLang[lang].handler || universal;
        var words = jQuery.syotimerLang[lang][unit];
    ...
    var SyoTimer = /** @class */ (function () {
        ...
        SyoTimer.prototype.render = function () {
            ...
            var headBlock = jQuery__default['default']('<div/>', { class: 'syotimer__head' }).html(options.headTitle);
            var bodyBlock = jQuery__default['default']('<div/>', { class: 'syotimer__body' });
            var footBlock = jQuery__default['default']('<div/>', { class: 'syotimer__footer' }).html(options.footTitle);
            var itemBlocks = {};
        ...
        SyoTimer.prototype.tick = function () {
            var options = this.element.data('syotimer-options');
            jQuery__default['default']('.syotimer-cell > .syotimer-cell__value', this.element).css('opacity', 1);
            ...
            if (secondsToDeadLine >= 0) {
                ...
                var elementBox = jQuery__default['default'].extend(this.element, this.element.data('syotimer-blocks'));
        ...
        SyoTimer.prototype.refreshUnitsDom = function (secondsToDeadLine) {
            ...
            for (var i = 0; i < unitList.length; i += 1) {
                ...
                jQuery__default['default']('.syotimer-cell__value', itemBlock).html(format2(unitValue, unit !== DAY ? options.doubleNumbers : false));
                jQuery__default['default']('.syotimer-cell__unit', itemBlock).html(getNumeral(unitValue, options.lang, unit));
            }
        };
        /**
            ...
            switch (effectType) {
                case 'opacity': {
                    ...
                    if (unitItemBlock) {
                        ...
                        jQuery__default['default']('.syotimer-cell__value', unitItemBlock).animate({ opacity: 0.1 }, 1000, 'linear', function () {
                            return _this.tick();
                        });
    ...
    function mapSyoTimer(elements, inputOptions) {
        var options = jQuery__default['default'].extend({}, defaultOptions, inputOptions || {});
        options.itemTypes = getItemTypesByLayout(options.layout);
        options.itemsHas = jQuery__default['default'].extend({}, defaultItemsHas);
        for (var i = 0; i < options.itemTypes.length; i += 1) {
    ...
    var methods = {
        setOption: function (name, value) {
            var elementBox = jQuery__default['default'](this);
    ...
    jQuery__default['default'].fn.extend({
        syotimer: function (options, property, value) {
            ...
            return jQuery__default['default'].error('SyoTimer. Error in call methods: methods is not exist');
        },
    });
