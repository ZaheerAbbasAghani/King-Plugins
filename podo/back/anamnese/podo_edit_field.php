...
add_action( 'wp_ajax_nopriv_podo_edit_customer', 'podo_edit_customer' );
add_action( 'wp_ajax_podo_edit_customer', 'podo_edit_customer' );
function podo_edit_customer() {
...
$info .= '<div class="mainClassDokument">
...
<label> Art des Eintrags:
	<select id="field_type"><option value="" selected disabled>Select a field </option>';
