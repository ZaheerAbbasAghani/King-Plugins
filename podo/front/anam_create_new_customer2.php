...
add_action( 'wp_ajax_nopriv_anam_create_new_customer_2', 'anam_create_new_customer_2' );
add_action( 'wp_ajax_anam_create_new_customer_2', 'anam_create_new_customer_2' );
function anam_create_new_customer_2() {
...
//print_r($cinfo);
	...
	$response = array("message" => "Ihre persönlichen Informationen wurden erfolgreich erfasst!", "status" => 1);
