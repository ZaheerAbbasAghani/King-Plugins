<?php
add_action( "init", "gvw_create_cpt");
function gvw_create_cpt() {
  ...
  register_post_type( 'aem_events', $args ); 
}
...
function events_extra_information() {
    add_meta_box( 
        ...
        __( 'event Extra Information', 'events' ),
...
function events_extra_information_content( $post ) {
  ...
  echo '<input type="text" id="lfs_phone_number" name="lfs_phone_number" placeholder="Enter event lasting" value="'.$lfs_phone_number.'" style="width:100%;"/></label>';
