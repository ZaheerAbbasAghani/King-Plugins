<?php
/*
Plugin Name: Daily Post With Polylang
...
function dp_start_from_here() {
	...
	require_once plugin_dir_path(__FILE__) . 'back/dp_get_post_by_value.php';
...
if (class_exists('DailyPostWithPolylang')) {
	$obj = new DailyPostWithPolylang();
