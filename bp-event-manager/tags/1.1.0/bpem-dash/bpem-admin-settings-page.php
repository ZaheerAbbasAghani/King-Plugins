...
function my_cool_plugin_create_menu() {
	...
	add_submenu_page('edit.php?post_type=bpem_event', 'Settings', 'BPEM Settings', 'manage_options', 'bp_event_manager_settings', 'bpem_plugin_settings_page', 'dashicons-admin-customizer ');
