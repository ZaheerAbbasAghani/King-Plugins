=== BP Event Manager ===
Tags: bp-event-manager,Buddypress,Events,Event Manager,Meetup
Requires at least: 1.1.0
Tested up to: 5.2.7
Requires PHP: 5.6.20
Contributors: zaheer01
...
* Note: Both above shortcode can be used in single.php file.
Watch Demo Video 

[youtube https://www.youtube.com/watch?v=AkpYb9HM3lU]
...
1. This is create events form
2. This is upcoming and past events before attend
3. This is upcoming and past events after attend
4. This is details of event
5. This is event calendar by group
6. This is the details of events in dashboard.