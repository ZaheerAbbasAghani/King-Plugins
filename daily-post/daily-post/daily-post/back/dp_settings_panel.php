...
function dp_plugin_create_menu() {
	...
	add_menu_page('Daily Post Settings', 'Daily Post', 'manage_options', 'daily_post_settings', 'dp_plugin_settings_page','dashicons-plus-alt',25);
        ...
        <th scope="row"> Categories </th>
	        <td> 
	        	<select name="dp_select_category">
	        		<option>No Default Category</option>
	        		<?php 
