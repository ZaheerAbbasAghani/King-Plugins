...
function br_start_from_here() {
    ...
    require_once plugin_dir_path(__FILE__) . 'front/br_remove_connection.php';
}
  ...
  //  print_r($relay);
 	...
 	$result .= "<p>".$rel->br_relation."</p>";
	    if(get_current_user_id() == bp_displayed_user_id()){
	    	$result .= "<a href='#' data-id='".$rel->id."' class='remove_collection'>Remove Connection</a>";
	    }
 	}
